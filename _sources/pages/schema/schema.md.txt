...
* The messages while not directly human-readable, can be decoded using the [protobuf schema](https://github.com/cmu-mfi/mfi_ddb_library/blob/main/schema/spbv.proto). Some MQTT brokers, [like EMQX](https://www.emqx.com/en/blog/mqtt-sparkplug-in-action-a-step-by-step-tutorial), have built in capability to do so.
...
* The schema is defined in [blob.proto](https://github.com/cmu-mfi/mfi_ddb_library/blob/main/schema/blob.proto).
...
* The schema is defined in [kv.json](https://github.com/cmu-mfi/mfi_ddb_library/blob/main/schema/kv.json).
